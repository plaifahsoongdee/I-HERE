...
function DashboardLayout() {
  ...
  // รวมรายการรายรับ รายจ่าย และยอดเงินเก็บสำหรับการแสดงใน LatestEntries
  const combinedEntries = entries["รายรับ"]
    .concat(entries["รายจ่าย"], entries["ยอดเงินเก็บ"]) // เพิ่มยอดเงินเก็บเข้าไปใน combinedEntries
    .sort((a, b) => new Date(b.date) - new Date(a.date) || b.time.localeCompare(a.time)); // เรียงตามวันที่และเวลา

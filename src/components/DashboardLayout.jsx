    ...
    <div style={dashboardContainerStyle}>
      ...
      <div style={contentStyle}>
        ...
        <div style={cardGridStyle}>
          <OverviewCard title="รายรับ" value="รายรับล่าสุด" entries={entries["รายรับ"]} onClick={() => openModal("รายรับ")} />
          <OverviewCard title="รายจ่าย" value="1.6k" percentage={-16} entries={entries["รายจ่าย"]} onClick={() => openModal("รายจ่าย")} />
          <OverviewCard title="ยอดเงินคงเหลือ" value="75.5%" entries={entries["ยอดเงินคงเหลือ"]} onClick={() => openModal("ยอดเงินคงเหลือ")} />
          <OverviewCard title="ยอดเงินเก็บ" value="$15k" entries={entries["ยอดเงินเก็บ"]} onClick={() => openModal("ยอดเงินเก็บ")} />
        </div>
